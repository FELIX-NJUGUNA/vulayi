...
import bookingvisual from "../assets/images/booking.webp";
    ...
    <Section id="booking">
      <Container>
        ...
        >
          ...
          >
            <input type="hidden" name="access_key" value="5dacb01f-fd01-421e-ab84-1547cc7ad16b" />
            <input type="hidden" name="from_name" value="Vulayi Booking Form" />
            <input type="hidden" name="subject" value="🛎️ New Booking Received - Vulayi" />
            <input type="hidden" name="replyto" value="client@email.com" />
            {/* Optional success page */}
            {/* <input type="hidden" name="redirect" value="https://vulayi.com/thank-you" /> */}
        ...
        <Right
          ...
          transition={{ duration: 0.6 }}
        >
          <Image src={bookingvisual.src} alt="Booking visual" />
        </Right>
      </Container>
    </Section>
  );
